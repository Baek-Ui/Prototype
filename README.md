...
💡 **빠른 테스트를 위한 예시 유튜브 URL**
> 본 프로토타입은 데모 시뮬레이션(Mock AI Pipeline) 환경으로 작동합니다. 입력창에 아래의 예시 URL을 복사하여 간편하게 테스트해 보실 수 있습니다. (물론 실제 다른 유튜브 영상 주소를 입력하셔도 작동합니다!)
> * **예시 1 (딥페이크 탐지 및 음성 위조 테스트용 뉴스):** `https://www.youtube.com/watch?v=khmK824c9c8`
> * **예시 2 (정부 보도 및 정책 팩트체크 테스트용):** `https://www.youtube.com/watch?v=F0f4uJ9p1Ew`
> * **예시 3 (기타 범용 영상 테스트용):** `https://www.youtube.com/watch?v=dQw4w9WgXcQ`
...
## ⚙️핵심 기능
### 1. 실시간 유튜브 영상 분석
단순 URL 입력만으로 유튜브 영상에 대한 정밀 분석이 가능합니다. 실시간 스트리밍 분석 기술을 통해 사용자는 기다림 없이 빠르게 결과를 확인할 수 있습니다. *(💡 상단의 **실시간 라이브 데모** 섹션에 제공된 예시 URL을 복제하여 입력 창에 넣어보세요!)*
